(function() {
    ...
    //we check if the user is signed in. if not, we prevent them from getting to the checkout
    CheckSignIn();
    //we check if the cart has no items, which will prevent the user going to the checkout
    CheckZero(cartObjects);
    //finally we render the cart
