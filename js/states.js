  $(document).ready(function(){
    ...
    if (localStorage.getItem('userdetails') === null) {  
        ...
        var userDetails = {firstName:"Vladimir", lastName:"Putin", dob:"1952-10-07",address1:"Head Office, Kremlin", address2:"Moscow", country:"Russian Federation"};
    ...
    $('form[name="login"]' ).submit(function( event ) {
        ...
        if (email=="vladdyp@kremlin.ru" && password=="password1")  {   
